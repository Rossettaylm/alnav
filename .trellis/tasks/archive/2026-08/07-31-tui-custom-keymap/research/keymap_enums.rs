...
impl ActionId {
    ...
    pub fn meta(self) -> ActionMeta {
        match self {
            ...
            Self::LogListJumpBottom => ActionMeta {
                ...
                capabilities: &[],
                label: "bottom",
                detail: "jump to bottom (no resume follow)",
            },
            ...
            Self::LogListDetailPretty => ActionMeta {
                ...
                capabilities: &[],
                label: "pretty",
                detail: "toggle pretty / swap overlay",
            },
    ...
    pub fn context(self) -> KeyContext { self.meta().context }
    pub fn toml_key(self) -> &'static str { self.meta().toml_key }
}
